 ...
 <div class="pure-g ">
    ...
    <div class="pure-u-1 l-box pure-u-md-3-4">
		...
		<div class="pure-control-group">
			...
			<input id="firstName" type="text" class="pure-input-3-4" v-model="firstName" @input="$v.firstName.$touch()" placeholder="First name" required/>
			<input id="surName" type="text" class="pure-input-3-4" v-model="surname" @input="$v.surname.$touch()" placeholder="Surname" required/>
			<input id="idNo" type="text" class="pure-input-3-4" v-model="idNumber" @input="$v.idNumber.$touch()" placeholder="ID Number" required/>
			<input id="email" class="pure-input-3-4" type="text" v-model="email" @input="$v.email.$touch()" placeholder="Email" required/>
			<input id="dob" class="pure-input-3-4" type="text" v-model="dob" @input="$v.dob.$touch()" placeholder="DD-MM-YY" required/>
...
<input type="text" class="pure-input-1 is-center" placeholder="Pl Number">
</div>
-->
...
<div class="pure-u-1 pure-u-md-1-2">
<select name="Year" v-model="startDate" class="pure-input-1 is-center">
...
<div class="pure-u-1 pure-u-md-1-2">
	<select v-model="policy" name="Policy" class="pure-input-1 is-center">
		<option value="pol001">Policy 1</option>
		<option value="pol002">Policy 2</option>
		<option value="pol003">Policy 3</option>
		<option value="pol004">Policy 4</option>
	</select>
</div>
<!--
<div class="pure-u-1 pure-u-md-1-2">
...
<!--
<button  class="pure-button pure-input-1-2 pure-button-primary" @click="doPay">Proceed</button>
-->
<!--
